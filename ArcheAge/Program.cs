...
namespace ArcheAge
{
    ...
    class Program
    {
        ...
        public static UInt32UidFactory CharcterUid; //UID for a character
        public static UInt32UidFactory AccountUid; //UID for account
        public static UInt32UidFactory ObjectUid; //UID for things/Items

        static void Main(string[] args)
        {
            AccountUid = new UInt32UidFactory(AccountHolder.MaxAccountUid());      //generate UID for accounts
            CharcterUid = new UInt32UidFactory(CharacterHolder.MaxCharacterUid()); //generate UID for characters
            //ObjectUid = new UInt32UidFactory(CharacterHolder.MaxObjectUid()); //generate UID for things/Items
            ObjectUid = new UInt32UidFactory(); //TODO: test, until are starting with zero
