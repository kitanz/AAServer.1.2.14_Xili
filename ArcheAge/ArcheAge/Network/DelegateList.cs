...
namespace ArcheAge.ArcheAge.Network
{
    ...
    public static class DelegateList
    {
        ...
        public static List<Character> CharacterList = new List<Character>(); //here will be stored a list of characters for the current account
        ...
        public static void Initialize(string clientVersion)
        {
            ...
            once2 = true; //если false, do not repeat again
            once3 = true; //если false, do not repeat again
            once4 = true; //если false, do not repeat again
            once5 = true; //если false, do not repeat again
            once6 = true; //если false, do not repeat again
            enter1 = false; //если true, do not repeat again
            enter4 = false; //если true, do not repeat again
            enter5 = false; //если true, do not repeat again
            enter6 = false; //если true, do not repeat again
            enter7 = false; //если true, do not repeat again
            enter8 = false; //если true, do not repeat again
            enter9 = false; //если true, do not repeat again
        ...
        private static void RegisterDelegates()
        {
            ...
            switch (_clientVersion)
            {
                ...
                case "3": //3.0.3.0
                    ...
                    Register(0x05, 0x008A, OnPacketReceive_EnterWorld_0x008A); //entering game1
                    Register(0x05, 0x008B, OnPacketReceive_EnterWorld_0x008B); //login to the game2
                    Register(0x05, 0x008C, OnPacketReceive_EnterWorld_0x008C); //login to the game3
                    Register(0x05, 0x008D, OnPacketReceive_EnterWorld_0x008D); //login to the game4
                    Register(0x05, 0x008E, OnPacketReceive_EnterWorld_0x008E); //login to the game5
                    Register(0x05, 0x008F, OnPacketReceive_EnterWorld_0x008F); //login to the game6
                    break;
                default:
                    break;
            }
