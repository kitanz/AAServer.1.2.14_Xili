...
namespace ArcheAge.ArcheAge.Network
{
    public sealed class NP_X2EnterWorldResponsePacket_0x0000 : NetPacket
    {
        ...
        public NP_X2EnterWorldResponsePacket_0x0000(string clientversion) : base(05, 0x00)
        {
            ...
            {
                case "1":
                    //made a separate class because the base code = base(01, 0x00) for version 1.0, not base (05, 0x00) as for version 3.0
                    break;
                case "3":
                    /*
                    ...
                    */
                    ...
                    ns.Write((long) 0x7F000001); //wf - attempt
