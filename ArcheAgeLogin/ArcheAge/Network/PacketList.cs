        ...
        private static void Registration()
        {
            ...
            switch (_clientVersion)
            {
                case "1"://1.0.1406 Feb 11 2014
                    //the sequence of packets when the client connects to LoginServer
                    ...
                    //-------------------------------------
                    Register(0x01, Handle_CARequestAuthPacket_0x01);
                    Register(0x04, Handle_CARequestAuth_0x04); //packet #1 from client
                    Register(0x0A, Handle_CAListWorld_0x0A);  //
                    Register(0x0A, Handle_CAListWorld_0x0A);  //
                    Register(0x0B, Handle_CAEnterWorld_0x0B);  //
                    Register(0x0D, Handle_CARequestReconnect_0x0D);
                    //Fix by Shannon
                    Register(0x08, Handle_CAListWorld_0x0A);  //packet #2 from client test
                    Register(0x09, Handle_CAEnterWorld_0x0B);  //packet #3 from client test
                    break;
                case "3": //3.0.3.0
                    Register(0x06, Handle_CAChallengeResponse2_0X06); //package #1 from client
                    Register(0x0c, Handle_CACancelEnterWorld_0X0C); //packet #2 from the client
                    Register(0x0d, Handle_CARequestReconnect_0X0D); //packet #3 from client
                    Register(0x0f, Handle_CARequestReconnect_0X0F); //packet #3 from client
                    break;
                default:
                    Register(0x06, Handle_CAChallengeResponse2_0X06); //packet #1 from customer
